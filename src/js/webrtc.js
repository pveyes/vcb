...
var webrtc = (function() {
	...
	webrtc.handleAskOffer = function(d) {
		...
		channel.onclose = function(e) {
			console.log("handleAskOffer DataChannelObject onclose from: ", d.data.from);
			console.log(e);
		};
		channel.onerror = function(e) {
			console.log("handleAskOffer DataChannelObject onerror from: ", d.data.from);
			console.log(e);
		};
		channel.onmessage = function(e) {
			console.log("handleAskOffer DataChannelObject onmessage from: ", d.data.from);
			console.log(e);

			dataChannel.receiveMessage(d,e);
		};
		channel.onopen = function(e) {
			console.log("handleAskOffer DataChannelObject onopen from: ", d.data.from);
			console.log(e);
		...
		peer.onicecandidate = function(e){
			console.log('Info: handleAskOffer onicecandidate send from this PC to: ', d.data.from);
			console.log(e);
		...
		peer.onsignalingstatechange = function(e) {
			console.log('Info: handleAskOffer onsignalingstatechange from: ', d.data.from);
			console.log(e);
		};
		peer.oniceconnectionstatechange = function(e) {
			console.log('Info: handleAskOffer oniceconnectionstatechange from: ', d.data.from);
			console.log(e);
		};
		peer.onaddstream = function(e) {
			console.log('Info: handleAskOffer onaddstream from: ', d.data.from);
			console.log(e);
		...
		peer.onremovestream = function(e) {
			console.log('Info: handleAskOffer onremovestream from: ', d.data.from);
			console.log(e);
		};
		peer.createOffer(function(e) {
			console.log('Info: handleAskOffer createOffer from this PC to: ', d.data.from);
			console.log(e);
	...
	webrtc.handleGetOffer = function(d) {
		...
		peer.onicecandidate = function(e){
			console.log('Info: handleGetOffer onicecandidate send from this PC to '+d.data.from);
			console.log(e);
		...
		peer.onsignalingstatechange = function(e) {
			console.log('Info: handleGetOffer onsignalingstatechange from: ', d.data.from);
			console.log(e);
		};
		peer.oniceconnectionstatechange = function(e) {
			console.log('Info: handleGetOffer oniceconnectionstatechange from: ', d.data.from);
			console.log(e);
		};
		peer.onaddstream = function(e) {
			console.log('Info: handleGetOffer onaddstream from: ', d);
			console.log(e);
		...
		peer.onremovestream = function(e){
			console.log('Info: handleGetOffer onremovestream from: ', d.data.from);
			console.log(e);
		};
		peer.ondatachannel = function(e) {
			console.log('Info: handleGetOffer ondatachannel from: ', d.data.from);
			console.log(e);
			...
			channel.onclose = function(e) {
				console.log("handleGetOffer peer DataChannelObject onclose from: ", d.data.from)
				console.log(e)
			}
			channel.onerror = function(e) {
				console.log("handleGetOffer peer DataChannelObject onerror from: ", d.data.from)
				console.log(e)
			}
			channel.onmessage = function(e) {
				console.log("handleGetOffer peer DataChannelObject onmessage from: ", d.data.from)
				console.log(e);
				dataChannel.receiveMessage(d, e);
			}
			channel.onopen = function(e) {
				console.log("handleGetOffer peer DataChannelObject onopen", d);
				console.log(e)
			}
		};
		...
		peer.createAnswer(function(e){
			console.log('Info: handleGetOffer createAnswer from this PC to '+d.data.from); console.log(e);
			webrtc.peers[d.data.from].session.local = e;
			var res = {
				status:true,
				data:{
